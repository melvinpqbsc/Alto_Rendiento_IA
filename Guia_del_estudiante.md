...
- **Todo trabajo se guarda en tu fork del repositorio en GitHub** y se entrega enviando el enlace. Cuenta la última versión guardada antes del inicio de la clase. El paso a paso está en la sección [Antes de empezar: GitHub](README.md#antes-de-empezar-github) del README.
...
- [ ] Crear una cuenta en [GitHub](https://github.com/), hacer un *fork* del [repositorio del curso](https://github.com/melvinpqbsc/Alto_Rendiento_IA) y enviarle tu usuario al profesor. Instrucciones en [Antes de empezar: GitHub](README.md#antes-de-empezar-github).
